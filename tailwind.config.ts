  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ...colors,
        primary: colors["brand-yellow"][6],
        primaryLight: colors["brand-blue"][6],
        green: colors["brand-green"][6],
        orange: colors["brand-orange"][6],
        blue: colors["brand-blue"][6],
        gray: colors["brand-gray"][6],
