...
const slides = [
      ...
      <PatternBackground pattern="circuit">
        <div className="py-12 px-6">
          ...
          <p>
            ...
            Toxic Silver won us an Excellence in Engineering Award at the
            Greater Pittsburgh Regional and Rank 8 at the Battle O&apos;
            Baltimore.
          </p>
        </div>
      </PatternBackground>
  ...
  <>
    <h1 className="heading-2 text-7xl text-center">2020-2021</h1>
  ...
  <>
    <h1 className="heading-2 text-7xl text-center">2022</h1>
    ...
    <div className="border-y-8 border-yellow-400">
      <PatternBackground pattern="circuit">
        <div className="py-12 px-6">
          ...
          <p>
            One of our heavier robots, O&apos;Mega boasts a giant cannon, a
            sizeable intake, and two climbing arms. An adjustable firing
            mechanism allowed it to shoot into both hoops in the 2022 game, and
            won us a spot in the finals and an Industrial Design Award.
          </p>
        </div>
      </PatternBackground>
    </div>
  ...
  <>
    <h1 className="heading-2 text-7xl text-center">2023</h1>
    ...
    <div className="border-y-8 border-yellow-400">
      <PatternBackground pattern="circuit">
        <div className="py-12 px-6">
          ...
          <p>
            Competing in the 2023 Pittsburgh Regional Competition, Viper won us
            the Industrial Design Award, and a few curious looks from fellow
            teams. Its main features are the three foot metal arm and 3d printed
            pneumatic claw, used to atriculate inflatable cubes. Mecanum wheels
            allow it to fine-tune its position, and dual cameras gave our
            drivers lots of visibilty.
          </p>
        </div>
      </PatternBackground>
    </div>
  ...
  <>
    <h1 className="heading-2 text-7xl text-center">2024</h1>
      ...
      <PatternBackground pattern="circuit">
        <div className="py-12 px-6">
          ...
          <p>
            ...
            like a sore thumb with its sleek gunmetal sides and concealed
            electronics. A 3d printed chain carries game pieces from the ground
            up to the peak of the ramp, and a pair of motors shoot it forward.
            Coming back from a loss in Pittsburgh, this machine got us 15th
            place at the Buckeye Valley Regional and helped us win our Imagery
            Award in the 2023-2024 season.
          </p>
        </div>
      </PatternBackground>
    </div>
  ...
  <>
    <h1 className="heading-2 text-7xl text-center">2025</h1>
    <ParallaxImage>
      <SlideButtons></SlideButtons>
    </ParallaxImage>
    <div className="border-y-8 border-yellow-400">
