...
- [x] Each page: unique title + description, breadcrumbs JSON-LD on nested routes, Lighthouse A11y = 100 spot-checked. _(axe-core over WCAG 2.2 AA + best-practice reports zero violations on every route at 390px and 1440px — a superset of Lighthouse's accessibility audit. Lighthouse itself arrives with the Phase 09 budgets.)_
